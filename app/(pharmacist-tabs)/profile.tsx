  ...
  return (
    <ScrollView style={styles.container}>
      ...
      >
        <View style={styles.profileInfo}>
          ...
          <View style={styles.userInfo}>
            <Text style={styles.doctorName}>{user?.firstName} {user?.lastName}</Text>
            <Text style={styles.specialty}>Pharmacist</Text>
      ...
      <View style={styles.quickSettings}>
        <View style={styles.settingItem}>
          <View style={styles.settingInfo}>
            <FontAwesome name="bell" size={20} color="#8b7355" />
            <Text style={styles.settingTitle}>Notifications</Text>
          </View>
          <Switch
            value={notificationsEnabled}
            onValueChange={handleNotificationsToggle}
            trackColor={{ false: '#bdc3c7', true: '#8b7355' }}
              ...
              >
                <View style={styles.menuItemLeft}>
                  <View style={styles.menuIcon}>
                    <FontAwesome name={item.icon as any} size={20} color="#8b7355" />
                  </View>
      ...
      <View style={styles.versionContainer}>
        <Text style={styles.versionText}>PharmaLink Pharmacist Portal v1.0.0</Text>
      </View>
